...
| Page | Czech | Slovak | English |
|------|-------|--------|---------|
| Support | [`/cs/podpora/`](https://martinstrambach.github.io/tankuj-site/cs/podpora/) | [`/sk/podpora/`](https://martinstrambach.github.io/tankuj-site/sk/podpora/) | [`/en/support/`](https://martinstrambach.github.io/tankuj-site/en/support/) |
| Privacy policy | [`/cs/soukromi/`](https://martinstrambach.github.io/tankuj-site/cs/soukromi/) | [`/sk/sukromie/`](https://martinstrambach.github.io/tankuj-site/sk/sukromie/) | [`/en/privacy/`](https://martinstrambach.github.io/tankuj-site/en/privacy/) |
...
The App Store listing points at these six URLs (`support_url.txt` and `privacy_url.txt`
